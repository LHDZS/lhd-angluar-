...
export const environment = {
    ...
    zlwProductionlimitServer: 'https://apiqlw.t.nxin.com/z/production-read', //限流
    ...
    // zlwBasicSettingServer: 'https://apiqlw.t.nxin.com/z/dev/basic', // 基础设置
    // zlwProductionServer: 'https://apiqlw.t.nxin.com/z/dev/production', // 基础
    // zlwProductionReadServer: 'https://apiqlw.t.nxin.com/z/dev/production-read',
    // zlwProductionlimitServer: ' https://apiqlw.t.nxin.com/z/dev/production-read', //限流
    // zlwProductionSowServer: 'https://apiqlw.t.nxin.com/z/dev/production/sow', // 母猪生产
    // zlwProductionSowReadServer: 'https://apiqlw.t.nxin.com/z/dev/production/sow-read',
    // qlwCommonService: 'https://apiqlw.t.nxin.com/qlw/base', // 企联网商品服务
    // qlwProductService: 'https://apiqlw.t.nxin.com/base/product', // 企联网商品服务
    // zlwPromptManageServer: 'https://apiqlw.t.nxin.com//z/dev/production/prompt', // 生产提示
    // zlwMaterialsManageServer: 'https://apiqlw.t.nxin.com/z/dev/materials', // 物资
    // zlwhealthManageServer: 'https://apiqlw.t.nxin.com/z/dev/health', //健康管理
    // zlwReportPigServer: 'https://apiqlw.t.nxin.com/z/dev/reportpig', //指标
    // qlwSystemServer: 'https://apiqlw.t.nxin.com/sys', // 企联网系统服务
    // zlwcostServer: 'https://apiqlw.t.nxin.com/z/dev/cost', // 成本
    // qlwCustomer: 'https://apiqlw.t.nxin.com/qlw/customer', // 客户/供应商
    // qlwBizMarket: 'https://apiqlw.t.nxin.com/qlw/market', //区域
    // qlwProductSetUrl: 'https://baseqlw.t.nxin.com/ProductWeb/ProductList?appid=1708231814060000101', //设置企联网商品地址
    // zlwBreedingServer: 'https://apiqlw.t.nxin.com/z/dev/breeding', // 育种
    // zlwOpsServer: 'https://apiqlw.t.nxin.com/z/ops', // 数据运维
