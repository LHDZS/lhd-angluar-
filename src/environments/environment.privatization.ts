...
export const environment = {
    //环境标识
    production: true,
    environmentType: environmentType.privatization,
    // 测试环境 Token 信息
    token: {
        userInfo: {
            userId: 0,
        ...
        server: 'https://open.t.nxin.com/api/nxin.architecture.st/1.0', //测试用
    ...
    costManagementServer: 'https://apiqlw.t.nxin.com/cost/management', // 标准成本管理
    //养户基础服务
