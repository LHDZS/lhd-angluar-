...
import { PickupChickSettingRoutingModule } from './yhproductpoultrymanage.routing';
...
@NgModule({
    imports: [
        CommonModule,
        PickupChickSettingRoutingModule,
        NxFormSingleModule,
    ...
    declarations: [PickupChickSettingComponent],
})
export class ZqPickupChickSettingModule {}
