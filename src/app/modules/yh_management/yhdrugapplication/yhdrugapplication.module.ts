...
import { YhDrugApplicationRoutingModule } from './yhdrugapplication.routing';
...
@NgModule({
    imports: [
        CommonModule,
        YhDrugApplicationRoutingModule,
    ...
    providers: [YhDrugApplicationService],
    declarations: [YhDrugApplicationListComponent, YhDrugApplicationDetailComponent],
})
export class YhDrugApplicationModule {}
