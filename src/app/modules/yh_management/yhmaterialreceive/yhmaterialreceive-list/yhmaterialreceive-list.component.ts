...
@Component({
    selector: 'yhmaterialreceive',
    templateUrl: './yhmaterialreceive-list.component.html',
    styleUrls: ['./yhmaterialreceive-list.component.scss'],
})
export class YhMaterialReceiveListComponent {
    datasource: any = null;
    ...
    //#region 初始化表格配置
    init_data_grid(): YhMaterialReceiveListComponent {
        ...
        this.dataGridModel.stateStoring.storageKey = 'YhMaterialReceive-list';
    ...
    get columns() {
        ...
        // col_Driver.props.lookup.dataSource = this.qlwOdataContext.getQlWPersonOData({
        //     select: ['UserID', 'PersonName'],
        // });
        // col_Driver.props.lookup.valueExpr = 'UserID';
        // col_Driver.props.lookup.displayExpr = 'PersonName';
    ...
    //#endregion
    //#region 初始化工具条配置
    init_toolbar_panel(): YhMaterialReceiveListComponent {
        ...
        this.toolbarPanelModel.settings.push(
            ...[
                ...
                new ColumnSetting('数量', 'Quantity'),
                new ColumnSetting('件数', 'Packages'),
        ...
        // 设置隐藏列缓存
        this.toolbarPanelModel.storageKey = 'YhMaterialReceive-columns-storage';
