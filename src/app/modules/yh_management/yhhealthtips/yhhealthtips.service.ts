...
@Injectable()
export class yhhealthtipsService {
    //套餐类型
    ...
    get store() {
        return new ODataStore({
            url: `${environment.yhProductionReadServer}/oq/HealthTipsList`,
            key: 'RecordID',
            keyType: 'String',
            version: 4,
            beforeSend: (e) => {
    ...
    /** 保健程序 */
    HealthProgramList(params) {
        return this._http.get(`${ODATA_URL_INFO.poultryProductOdataUrl}/HealthProgramList`+ params);
    }
