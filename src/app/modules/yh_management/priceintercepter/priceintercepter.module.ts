...
import { PriceIntercepterDetailComponent } from './priceintercepter-detail/priceintercepter-detail.component';
import { PriceIntercepterListComponent } from './priceintercepter-list/priceintercepter-list.component';
...
@NgModule({
    imports: [
        ...
        RouterModule.forChild([
            {
                path: '',
                component: PriceIntercepterListComponent,
            },
            {
                path: 'detail',
                component: PriceIntercepterDetailComponent,
            },
        ]),
    ],
    declarations: [
        PriceIntercepterListComponent,
        PriceIntercepterDetailComponent
    ],
})
export class PriceIntercepterModule {}
