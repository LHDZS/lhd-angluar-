...
import { SubsidyProgrammeRoutingModule } from './subsidyprogramme.routing';
...
@NgModule({
    ...
    declarations: [SubsidyProgrammeComponent],
})
export class SubsidyProgrammeModule {}
