...
@Component({
    selector: 'yhpoultrysales-list',
    templateUrl: './yhpoultrysales-list.component.html',
    styleUrls: ['./yhpoultrysales-list.component.scss'],
})
export class YHPoultrSalesListComponent {
    datasource: any = null;
    ...
    //#region 初始化表格配置
    init_data_grid(): YHPoultrSalesListComponent {
        ...
        this.dataGridModel.stateStoring.storageKey = 'yhpoultrysales-list';
        return this;
    }
    get columns() {
        //订单日期
    ...
    //#region 初始化工具条配置
    init_toolbar_panel(): YHPoultrSalesListComponent {
        ...
        // 设置隐藏列缓存
        this.toolbarPanelModel.storageKey = 'yhpoultrysales-list-storage';
