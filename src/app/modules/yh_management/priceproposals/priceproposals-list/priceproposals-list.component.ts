...
import { PriceProposalsService } from '../priceproposals.service';
...
@Component({
    selector: 'app-priceproposals-list',
    templateUrl: './priceproposals-list.component.html',
    styleUrls: ['./priceproposals-list.component.scss'],
    providers: [PriceProposalsService],
})
export class PriceProposalsListComponent {
    datasource: any = null;
    ...
    constructor(
        ...
        private service: PriceProposalsService,
        ...
        this.excelModel = {
            title: this.importService.yhpriceproposals.title,
            xlsxTemplatePath: this.importService.yhpriceproposals.xlsxPath,
            jsonTemplatePath: this.importService.yhpriceproposals.jsonPath,
            importServer: this.importService.yhpriceproposals.server,
    ...
    //#region 初始化表格配置
    init_data_grid(): PriceProposalsListComponent {
        ...
        this.dataGridModel.stateStoring.storageKey = 'priceproposals-list';
        return this;
    }
    get columns() {
    ...
    create() {
        HomeHelper.open(
            {
                title: '领用价格方案-新增',
                url: `${environment.qqlwUri}/priceproposals/detail?mode=create`,
            },
            () => {
    ...
    edit(rowData) {
        HomeHelper.open(
            {
                title: '领用价格方案-编辑',
                url: `${environment.qqlwUri}/priceproposals/detail?mode=edit&numericalOrder=${rowData.data.NumericalOrder}`,
            },
            () => {
                this._router.navigate(['/priceproposals/detail'], {
                    queryParams: {
    ...
    //#endregion
    //#region 初始化工具条配置
    init_toolbar_panel(): PriceProposalsListComponent {
        ...
        // 设置隐藏列缓存
        this.toolbarPanelModel.storageKey = 'priceproposals-columns-storage';
