...
import { yhsettlementRoutes } from './yhsettlement.routing';
...
@NgModule({
    ...
    declarations: [yhsettlementListComponent, yhsettlementDetailComponent],
    providers: [yhsettlementService],
})
export class yhsettlementModule { }
