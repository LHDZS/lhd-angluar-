...
import { layEggsIndexRoutes } from './layEggsIndex.routing';
...
@NgModule({
    ...
    declarations: [layEggsIndexListComponent, layEggsIndexDetailComponent],
    providers: [layEggsIndexService],
})
export class layEggsIndexModule {}
